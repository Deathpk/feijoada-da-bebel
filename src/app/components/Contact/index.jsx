    ...
    return(
        <section className="bg-[#FEF2D4] py-4">
            <div className=" text-[#84281f] text-4xl font-extrabold py-2">
                ...
                <div className="flex justify-center items-center">
                    <h5 className="max-w-2xl text-2xl font-bold tracking-tight leading-none md:text-2xl xl:text-3xl dark:text-white">Rua Astolfo Bueno, 81, Céu Azul, Belo Horizonte</h5>
                </div>
