                ...
                {items.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="md:w-1/2 md:p-6 mt-2">
                            ...
                            <a href={item.wppLink} 
                                className="flex justify-center px-5 py-3 text-base font-medium text-center hover:text-[#eaa558] text-[#84281f] border border-gray-300 rounded-lg bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
                                target="_blank"
                            >
                                Encomendar
                            </a>     
